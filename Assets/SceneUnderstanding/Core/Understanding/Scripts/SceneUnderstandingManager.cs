...
namespace Microsoft.MixedReality.SceneUnderstanding.Samples.Unity
{
    ...
    public class SceneUnderstandingManager : SingletonMonoBehaviour<SceneUnderstandingManager>
    {
        ...
        /// <summary>SceneUnderstandingで生成されたMeshRenderer</summary>
        //public ReadOnlyCollection<MeshRenderer> SUMeshRenderers => _suMeshRenderers.AsReadOnly();

        #endregion

        #region Private Variables

        //private readonly List<MeshRenderer> _suMeshRenderers = new List<MeshRenderer>();
        /// <summary>SceneUnderstandingで生成されたMeshRenderer</summary>
        public List<MeshRenderer> _suMeshRenderers = new List<MeshRenderer>();
...
#pragma warning disable CS4014
                    UniTask.RunOnThreadPool(RetrieveDataContinuously);
#pragma warning restore CS4014
        ...
        /// </returns>
        public UniTask DisplayDataAsync()
        {
            // See if we already have a running task
            if (!displayTask.GetAwaiter().IsCompleted)
            {
        ...
        /// </param>
        private IEnumerator DisplayDataRoutine(UniTaskCompletionSource<bool> completionSource)
        {
            ...
            else
            {
                ...
                catch (Exception inner)
                {
                    ...
                    completionSource.TrySetException(outer);
                }
            }
            ...
            if (cachedDeserializedScene != null)
            {
                ...
                if (sceneToUnityTransformAsMatrix4x4 != null)
                {
                    ...
                    // 生成オブジェクトのMeshRendererクリア
                    _suMeshRenderers.Clear();
        ...
        private void AddMeshToUnityObject(GameObject unityObject, Mesh mesh, Color? color, Material material)
        {
            ...
            // 生成したメッシュのレンダラーをキャッシュ
            _suMeshRenderers.Add(mr);
        }
        ...
        private System.Numerics.Matrix4x4? GetSceneToUnityTransformAsMatrix4x4(SceneUnderstanding.Scene scene)
        {
            ...
            if (RunOnDevice)
            {
                ...
                Windows.Perception.Spatial.SpatialCoordinateSystem unityCoordinateSystem = Microsoft.MixedReality.OpenXR.PerceptionInterop.GetSceneCoordinateSystem(Pose.identity) as Windows.Perception.Spatial.SpatialCoordinateSystem;
...
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
        public async UniTask SaveBytesToDiskAsync()
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        ...
        /// to disk
        /// </summary>
        public async UniTask SaveObjsToDiskAsync()
        {
            DateTime currentDate = DateTime.Now;
            int year = currentDate.Year;
            int month = currentDate.Month;
        ...
        /// </summary>
        private async UniTask SaveAllSceneObjectsOfAKindAsOneObj(List<SceneUnderstanding.SceneObject> sceneObjects, Color? color, string fileName)
        {
...
// Await is conditionally compiled out based on platform but needs to be awaitable
#pragma warning disable CS1998 // Async method lacks 'await' operators and will run synchronously
        private async UniTask SaveStringToDiskAsync(string data, string fileName)
#pragma warning restore CS1998 // Async method lacks 'await' operators and will run synchronously
        {
